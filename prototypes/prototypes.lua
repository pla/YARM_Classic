data:extend(
{
...

    {
        ...
        style = 'green',
        icon = '__YARM_Classic__/graphics/resource-monitor-x32-white.png',
        icon_size = 32,
        small_icon = '__YARM_Classic__/graphics/resource-monitor-x24.png',
        small_icon_size = 24,
      },

    {
        ...
        icon = '__YARM_Classic__/graphics/resource-monitor.png',
        icon_size = 32,
...

    {
        ...
        icon = '__YARM_Classic__/graphics/rm_Overlay.png',
        icon_size = 32,
        ...
        picture =
        {
            filename = '__YARM_Classic__/graphics/rm_Overlay.png',
            priority = 'extra-high',
            width = 32,
            height = 32,
            shift = {0.0, 0.0}
...
local function button_graphics(xpos, ypos)
    return {
        filename = '__YARM_Classic__/graphics/gui.png',
